...
/**
 * Represents a point in a two-dimensional graph.
 *
 * A Node is a fundamental building block of graph-based pathfinding. It maintains its position
 * in 2D space and tracks all outgoing vectors (connections) to other nodes. Nodes can be
 * connected bidirectionally or unidirectionally.
 *
 * @class
 */
class Node {
